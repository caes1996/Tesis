...
public class PalabraNivel1  extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        dbP = new PalabraDB(PalabraNivel1.this);
        dbC = new CategoriaDB(PalabraNivel1.this);
        db = new UsuarioDB(PalabraNivel1.this);

        usuario = db.buscarUsuarios(1);
        categoria = dbC.buscarCategoria(Integer.parseInt(idCategoria));

        setContentView(R.layout.activity_palabranivel1);
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
        setupActionBar();

        LinearLayout layout = (LinearLayout) findViewById(R.id.layoutPalabrasNivel1);
    ...
    private void recibirId(){
        ...
        Log.d("PalabraN1Activity -> ", "Id categoría: " + idCategoria);
    }
