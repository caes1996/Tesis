...
public class PalabraNivel2 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        dbP = new PalabraDB(PalabraNivel2.this);
        dbC = new CategoriaDB(PalabraNivel2.this);
        db = new UsuarioDB(PalabraNivel2.this);

        usuario = db.buscarUsuarios(1);
        categoria = dbC.buscarCategoria(Integer.parseInt(idCategoria));

        setContentView(R.layout.activity_palabranivel2);
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
        setupActionBar();

        LinearLayout layout = (LinearLayout) findViewById(R.id.layoutPalabrasNivel2);
        LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT,
                LinearLayout.LayoutParams.MATCH_PARENT );

        ArrayList<Palabra> list = dbP.loadPalabra(categoria.getId());
        Log.d("PalabraN2Activity -> ", "tamano lista: " + list.size());
        ...
        for (int i = 0; i < list.size(); i++){
            if(list.get(i).getBloqueado() == 0){
                ...
                palabra.setOnClickListener(new PalabraNivel2.ButtonsOnClickListener(this, palabra));
    ...
    private void recibirId(){
        ...
        Log.d("PalabraN2Activity -> ", "Id categoría: " + idCategoria);
    }
    ...
    class ButtonsOnClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            Intent i = new Intent(context, FinalNivel2.class);
